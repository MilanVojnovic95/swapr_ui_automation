...
if (!ENV || !'swaprTest'.includes(ENV)) {
    console.log('Please use fallowing format to run the test: ENV=ipfsTest');
    process.exit()
}

const data = fs.readFileSync("metamask/extension_10_11_0_0.crx")
